...
T = TypeVar("T", bound="SecurityCollection")
...
class SecurityCollection:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for securities_item_data in _securities:
            securities_item = Security.from_dict(securities_item_data)

            securities.append(securities_item)

        pagination = Pagination.from_dict(d.pop("pagination"))

        security_collection = cls(
            securities=securities,
            pagination=pagination,
        )

        security_collection.additional_properties = d
