...
from ..models.post_api_v1_imports_json_body_amount_type_strategy import PostApiV1ImportsJsonBodyAmountTypeStrategy
from ..models.post_api_v1_imports_json_body_col_sep import PostApiV1ImportsJsonBodyColSep
from ..models.post_api_v1_imports_json_body_number_format import PostApiV1ImportsJsonBodyNumberFormat
from ..models.post_api_v1_imports_json_body_signage_convention import PostApiV1ImportsJsonBodySignageConvention
from ..models.post_api_v1_imports_json_body_type import PostApiV1ImportsJsonBodyType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApiV1ImportsJsonBody")


@_attrs_define
class PostApiV1ImportsJsonBody:
    """
    Attributes:
        ...
        type_ (PostApiV1ImportsJsonBodyType | Unset): Import type (defaults to TransactionImport)
        ...
        number_format (PostApiV1ImportsJsonBodyNumberFormat | Unset): CSV imports only. Number format for parsing
            amounts
        signage_convention (PostApiV1ImportsJsonBodySignageConvention | Unset): CSV imports only. How to interpret
            positive/negative amounts
        col_sep (PostApiV1ImportsJsonBodyColSep | Unset): CSV imports only. Column separator
        amount_type_strategy (PostApiV1ImportsJsonBodyAmountTypeStrategy | Unset): CSV imports only. Amount parsing
            strategy
    ...
    type_: PostApiV1ImportsJsonBodyType | Unset = UNSET
    ...
    number_format: PostApiV1ImportsJsonBodyNumberFormat | Unset = UNSET
    signage_convention: PostApiV1ImportsJsonBodySignageConvention | Unset = UNSET
    col_sep: PostApiV1ImportsJsonBodyColSep | Unset = UNSET
    amount_type_strategy: PostApiV1ImportsJsonBodyAmountTypeStrategy | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: PostApiV1ImportsJsonBodyType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PostApiV1ImportsJsonBodyType(_type_)
        ...
        number_format: PostApiV1ImportsJsonBodyNumberFormat | Unset
        if isinstance(_number_format, Unset):
            number_format = UNSET
        else:
            number_format = PostApiV1ImportsJsonBodyNumberFormat(_number_format)

        _signage_convention = d.pop("signage_convention", UNSET)
        signage_convention: PostApiV1ImportsJsonBodySignageConvention | Unset
        if isinstance(_signage_convention, Unset):
            signage_convention = UNSET
        else:
            signage_convention = PostApiV1ImportsJsonBodySignageConvention(_signage_convention)

        _col_sep = d.pop("col_sep", UNSET)
        col_sep: PostApiV1ImportsJsonBodyColSep | Unset
        if isinstance(_col_sep, Unset):
            col_sep = UNSET
        else:
            col_sep = PostApiV1ImportsJsonBodyColSep(_col_sep)

        _amount_type_strategy = d.pop("amount_type_strategy", UNSET)
        amount_type_strategy: PostApiV1ImportsJsonBodyAmountTypeStrategy | Unset
        if isinstance(_amount_type_strategy, Unset):
            amount_type_strategy = UNSET
        else:
            amount_type_strategy = PostApiV1ImportsJsonBodyAmountTypeStrategy(_amount_type_strategy)

        amount_type_inflow_value = d.pop("amount_type_inflow_value", UNSET)

        post_api_v1_imports_json_body = cls(
        ...
        post_api_v1_imports_json_body.additional_properties = d
        return post_api_v1_imports_json_body
