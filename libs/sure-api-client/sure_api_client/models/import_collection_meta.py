...
T = TypeVar("T", bound="ImportCollectionMeta")


@_attrs_define
class ImportCollectionMeta:
    """
    Attributes:
        current_page (int):
        total_pages (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_collection_meta.additional_properties = d
        return import_collection_meta
