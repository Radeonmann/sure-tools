...
if TYPE_CHECKING:
    from ..models.budget_category_category import BudgetCategoryCategory


T = TypeVar("T", bound="BudgetCategory")
...
class BudgetCategory:
    ...
    Attributes:
        ...
        category (BudgetCategoryCategory):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category = BudgetCategoryCategory.from_dict(d.pop("category"))
        ...
        budget_category.additional_properties = d
