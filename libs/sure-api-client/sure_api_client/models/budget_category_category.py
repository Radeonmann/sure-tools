...
T = TypeVar("T", bound="BudgetCategoryCategory")


@_attrs_define
class BudgetCategoryCategory:
    """
    Attributes:
        id (UUID):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        budget_category_category.additional_properties = d
        return budget_category_category
