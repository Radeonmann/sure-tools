...
T = TypeVar("T", bound="ImportRowDiagnosticCollectionMeta")


@_attrs_define
class ImportRowDiagnosticCollectionMeta:
    """
    Attributes:
        current_page (int):
        total_pages (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_row_diagnostic_collection_meta = cls(
            current_page=current_page,
            total_pages=total_pages,
            total_count=total_count,
            per_page=per_page,
        ...
        import_row_diagnostic_collection_meta.additional_properties = d
        return import_row_diagnostic_collection_meta
