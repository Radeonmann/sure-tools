...
T = TypeVar("T", bound="RuleCollectionMeta")


@_attrs_define
class RuleCollectionMeta:
    """
    Attributes:
        current_page (int):
        total_pages (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rule_collection_meta.additional_properties = d
        return rule_collection_meta
