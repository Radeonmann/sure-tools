...
from ...models.valuation_collection import ValuationCollection
...
) -> ErrorResponse | ValuationCollection | None:
    if response.status_code == 200:
        response_200 = ValuationCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ValuationCollection]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ValuationCollection
    """
