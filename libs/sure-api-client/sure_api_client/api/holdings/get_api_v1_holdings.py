...
from ...models.holding_collection import HoldingCollection
...
) -> ErrorResponse | HoldingCollection | None:
    if response.status_code == 200:
        response_200 = HoldingCollection.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HoldingCollection]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | HoldingCollection
    """
