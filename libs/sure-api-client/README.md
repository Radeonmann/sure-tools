# sure-api-client
A client library for accessing Sure API

## Usage
First, create a client:

```python
from sure_api_client import Client
...
```python
from sure_api_client import AuthenticatedClient
...
```python
from sure_api_client.models import MyDataModel
from sure_api_client.api.my_tag import get_my_data_model
from sure_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `sure_api_client.api.default`
